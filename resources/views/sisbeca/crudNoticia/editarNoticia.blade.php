...
@section('subtitle','Editar Articulo')
@section('content')
                ...
                <div class="panel-body">
                    ...
                    <form action="{{route('mantenimientoNoticia.update',$noticia->id)}}" accept-charset="UTF-8" enctype="multipart/form-data" method="POST" >
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Información del Contacto o Publicador..." value="{{$noticia->informacion_contacto}}" required name="informacion_contacto" type="text" id="informacion_contacto">
                        </div>
                        ...
                        <div class="form-group rendered" >
                            <div class="form-group">
                                ...
                                <input class="form-control" required placeholder="URL Articulo..." value="{{$noticia->url_articulo}}" name="url_articulo" type="url" id="url_articulo">
                            </div>
                        ...
                        <div class="form-group rendered" >
                            <div class="form-group">
                                ...
                                <select class="form-control " id="es_miembro_institucional" name="es_miembro_institucional">
                                    @if($noticia->es_miembro_institucional==0)
                        ...
                        <div class="form-group rendered2" >
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Email del Contacto..." value="{{$noticia->email_contacto}}" name="email_contacto" type="email" id="email_contacto">
                            </div>
                        ...
                        <div class="form-group rendered2" >
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Telefono del Contacto..." value="{{$noticia->telefono_contacto}}" name="telefono_contacto" type="tel" id="telefono_contacto">
                            </div>
