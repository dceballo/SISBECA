...
@section('content')
      ...
      <section id="seccionPrincipal" class="section" data-stellar-background-ratio="0.2">
         ...
         <div class="container">
            <div class="section-header">
               <h2 class="section-title">Membresias</h2>
               <hr class="lines">
                  ...
                  <div class="container">
                     <div class="row" id="contentPrincipal">
                        <div class="col-lg-6 col-sm-6 col-xs-6 box-item">
                           <a class="page-scroll" href="#membresiasCorporativas">
                           <span class="icon">
                           <i class="lnr lnr-apartment"></i>
                           </span>
                           </a>
                           <div class="text">
                              <h4>Membresía Corporativa</h4>
                           </div>
                        </div>
                        <div class="col-lg-6 col-sm-6 col-xs-6 box-item">
                           <a class="page-scroll" href="#membresiaInstitucional">
                           <span class="icon">
                           <i class="lnr lnr-graduation-hat"></i>
                           </span>
                           </a>
                           <div class="text">
                              <h4>Membresía Institucional</h4>
                           </div>
                        </div>
                     </div>
                  </div>
      ...
      <!--Inicio de Seccion de membresias membresiasCooporativas-->
      ...
      <section id="membresiaInstitucional" class="section">
         <div class="container">
            <div class="section-header">
            ...
            <div class="row letrasResponsive">
               <div class="side-center col-sm-12 col-md-12">
                  ...
                  <hr/>
                  <p>  <strong>¿Desea convertirse en un Miembro Educativo de AVAA?</strong> ¡Contactenos! </p>
               </div>
            </div>
         </div>
      </section>
